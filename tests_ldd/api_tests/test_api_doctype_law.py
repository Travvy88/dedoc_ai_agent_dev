# region MODULE_CONTRACT [DOMAIN(7): Testing, DocumentProcessing; CONCEPT(9): LawDoctype, LegalDocuments; TECH(7): unittest]
## @modulecontract
## @purpose Comprehensive validation of Dedoc API for law-type documents: articles, chapters, sections, applications, tables, hierarchical structure across TXT/HTML/PDF/DOCX/ODT formats.
## @scope Law document parsing: article/chapter/section hierarchy, applications, cellars, tables, FOIV classifier, multi-format support.
...
## @modulemap
## CLASS [API integration test class] => TestLawApiDocReader
## @usecases
## - [TestClass]: Developer (Run) => VerifyAPIBehavior => TestPassOrFail
def _module_contract():
    pass
# endregion MODULE_CONTRACT
# GREP_SUMMARY: law, legal, article, chapter, section, application, cellar, FOIV, codex, API test, document structure
# STRUCTURE: ▶ ┌law file (txt|html|pdf|docx|odt)┐ → ○ _send_request(document_type=law) → ⊕ __test_law_tree_sanity → ◇ validate article/chapter/section hierarchy → ∑ check applications + tables → ⎋ structural assertions
...
# region CLASS_TestLawApiDocReader [DOMAIN(7): Testing, DocumentProcessing; CONCEPT(7): APITest; TECH(7): unittest]
## @purpose API integration tests for Dedoc document processing — TestLawApiDocReader.
...
# region FUNC_test_law_txt [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law txt
## @complexity 6
...
# endregion FUNC_test_law_txt

# region FUNC_test_law_html [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law html
## @complexity 6
...
# endregion FUNC_test_law_html

# region FUNC_test_law_image [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law image
## @complexity 6
...
# endregion FUNC_test_law_image

# region METHOD__get_body [DOMAIN(6): Testing; CONCEPT(6): Helper; TECH(6): unittest]
## @purpose Helper method for test assertions
## @complexity 4
...
# endregion METHOD__get_body

# region METHOD__get_applications [DOMAIN(6): Testing; CONCEPT(6): Helper; TECH(6): unittest]
## @purpose Helper method for test assertions
## @complexity 4
...
# endregion METHOD__get_applications

# region METHOD__check_ukrf [DOMAIN(6): Testing; CONCEPT(6): Helper; TECH(6): unittest]
## @purpose Helper method for test assertions
## @complexity 4
...
# endregion METHOD__check_ukrf

# region FUNC_test_law_doc [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law doc
## @complexity 6
    def test_law_doc(self) -> None:
        file_name = "ukrf.doc"
        self._check_ukrf(file_name)

# endregion FUNC_test_law_doc

# region FUNC_test_law_docx [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law docx
## @complexity 6
    def test_law_docx(self) -> None:
        file_name = "ukrf.docx"
        self._check_ukrf(file_name)

# endregion FUNC_test_law_docx

# region FUNC_test_law_odt [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law odt
## @complexity 6
    def test_law_odt(self) -> None:
        file_name = "ukrf.odt"
        self._check_ukrf(file_name)
# endregion FUNC_test_law_odt

# region FUNC_test_law_article_multiline [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law article multiline
## @complexity 6
...
# endregion FUNC_test_law_article_multiline

# region FUNC_test_law_pdf_uc [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law pdf uc
## @complexity 6
...
# endregion FUNC_test_law_pdf_uc

# region FUNC_test_law_pdf_with_applications [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law pdf with applications
## @complexity 6
...
# endregion FUNC_test_law_pdf_with_applications

# region FUNC_test_chapter [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for chapter
## @complexity 6
...
# endregion FUNC_test_chapter

# region FUNC_test_changes [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for changes
## @complexity 6
...
# endregion FUNC_test_changes

# region FUNC_test_law_paragraphs [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law paragraphs
## @complexity 6
...
# endregion FUNC_test_law_paragraphs

# region FUNC_test_foiv_txt [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for foiv txt
## @complexity 6
...
# endregion FUNC_test_foiv_txt

# region FUNC_test_application_txt [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for application txt
## @complexity 6
    def test_application_txt(self) -> None:
        ...
        self.assertEqual("subitem", node["metadata"]["paragraph_type"])
# endregion FUNC_test_application_txt

# region FUNC_test_number_not_part [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for number not part
## @complexity 6
...
# endregion FUNC_test_number_not_part

# region FUNC_test_application_multiline [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for application multiline
## @complexity 6
...
# endregion FUNC_test_application_multiline

# region FUNC_test_auto_paragraph [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for auto paragraph
## @complexity 6
...
# endregion FUNC_test_auto_paragraph

# region FUNC_test_txt [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for txt
## @complexity 6
...
# endregion FUNC_test_txt

# region FUNC_test_chapter_article [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for chapter article
## @complexity 6
...
# endregion FUNC_test_chapter_article

# region FUNC_test_law_with_super_elements [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law with super elements
## @complexity 6
...
# endregion FUNC_test_law_with_super_elements

# region FUNC_test_law_html_with_table [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law html with table
## @complexity 6
...
# endregion FUNC_test_law_html_with_table

# region FUNC_test_law_html_with_part_item_quotes [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law html with part item quotes
## @complexity 6
...
# endregion FUNC_test_law_html_with_part_item_quotes

# region FUNC_test_law_html_with_applications [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law html with applications
## @complexity 6
...
# endregion FUNC_test_law_html_with_applications

# region FUNC_test_law_html_with_applications_after_header [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for law html with applications after header
## @complexity 6
...
# endregion FUNC_test_law_html_with_applications_after_header

# region FUNC_test_foiv_html [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for foiv html
## @complexity 6
...
# endregion FUNC_test_foiv_html

# region FUNC_test_html_invisible_table [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for html invisible table
## @complexity 6
...
# endregion FUNC_test_html_invisible_table

# region METHOD___test_law_tree_sanity [DOMAIN(6): Testing; CONCEPT(6): Helper; TECH(6): unittest]
## @purpose Helper method for test assertions
## @complexity 4
...
# endregion METHOD___test_law_tree_sanity
# endregion CLASS_TestLawApiDocReader