# region MODULE_CONTRACT [DOMAIN(7): Testing; CONCEPT(8): Attachments, EmbeddedFiles; TECH(7): unittest]
## @modulecontract
## @purpose Comprehensive Dedoc API attachment extraction tests: PDF, DOCX, XLSX, JSON with embedded files, recursion depth control, base64 encoding.
## @scope Attachment extraction: multi-format attachments, recursion depth, content analysis toggle, base64 encoding, JSON HTML fields.
...
## @modulemap
## CLASS [API integration test class] => TestApiAttachmentsReader
## @usecases
## - [TestClass]: Developer (Run) => VerifyAPIBehavior => TestPassOrFail
def _module_contract():
    pass
# endregion MODULE_CONTRACT
# GREP_SUMMARY: attachments, embedded, extraction, recursion, base64, PDF, DOCX, XLSX, JSON, API test
# STRUCTURE: ▶ ┌document with attachments┐ → ○ _send_request(with_attachments, recursion_deep) → ⊕ extract embedded files → ◇ validate attachment metadata + content → ⎋ depth + encoding checks
...
# region CLASS_TestApiAttachmentsReader [DOMAIN(7): Testing, DocumentProcessing; CONCEPT(7): APITest; TECH(7): unittest]
## @purpose API integration tests for Dedoc document processing — TestApiAttachmentsReader.
class TestApiAttachmentsReader(AbstractTestApiDocReader):

    data_directory_path = AbstractTestApiDocReader.data_directory_path


# region METHOD__check_attachments [DOMAIN(6): Testing; CONCEPT(6): Helper; TECH(6): unittest]
...
# endregion METHOD__check_attachments

# region FUNC_test_wo_attachments_excel [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for wo attachments excel
## @complexity 6
...
# endregion FUNC_test_wo_attachments_excel

# region FUNC_test_get_attachments_xlxs_depth_1 [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for get attachments xlxs depth 1
## @complexity 6
...
# endregion FUNC_test_get_attachments_xlxs_depth_1

# region FUNC_test_get_attachments_xls_depth_1 [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for get attachments xls depth 1
## @complexity 6
...
# endregion FUNC_test_get_attachments_xls_depth_1

# region FUNC_test_get_attachments_pdf_depth_1 [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for get attachments pdf depth 1
## @complexity 6
...
# endregion FUNC_test_get_attachments_pdf_depth_1

# region FUNC_test_attachments_pmi_document [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for attachments pmi document
## @complexity 6
...
# endregion FUNC_test_attachments_pmi_document

# region FUNC_test_need_content_analysis [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for need content analysis
## @complexity 6
...
# endregion FUNC_test_need_content_analysis

# region FUNC_test_get_without_attachments [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for get without attachments
## @complexity 6
...
# endregion FUNC_test_get_without_attachments

# region FUNC_test_json_attachments [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for json attachments
## @complexity 6
...
# endregion FUNC_test_json_attachments

# region FUNC_test_json_invalid_html_fields [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for json invalid html fields
## @complexity 6
...
# endregion FUNC_test_json_invalid_html_fields

# region FUNC_test_json_with_html_fields_with_scripts [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for json with html fields with scripts
## @complexity 6
...
# endregion FUNC_test_json_with_html_fields_with_scripts

# region FUNC_test_json_with_bad_style_in_html [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for json with bad style in html
## @complexity 6
...
# endregion FUNC_test_json_with_bad_style_in_html

# region FUNC_test_docx_attachments [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for docx attachments
## @complexity 6
...
# endregion FUNC_test_docx_attachments

# region FUNC_test_docx_images_base64 [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for docx images base64
## @complexity 6
...
# endregion FUNC_test_docx_images_base64

# region FUNC_test_docx_images_no_base64 [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for docx images no base64
## @complexity 6
...
# endregion FUNC_test_docx_images_no_base64

# region METHOD___check_base64 [DOMAIN(6): Testing; CONCEPT(6): Helper; TECH(6): unittest]
## @purpose Helper method for test assertions
## @complexity 4
...
# endregion METHOD___check_base64

# region FUNC_test_attachments_recursion [DOMAIN(7): Testing; CONCEPT(7): ResponseValidation; TECH(7): unittest]
## @purpose Verify API response for attachments recursion
## @complexity 6
...
# endregion FUNC_test_attachments_recursion
# endregion CLASS_TestApiAttachmentsReader