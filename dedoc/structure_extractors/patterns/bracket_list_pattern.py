...
# region CLASS_BracketListPattern [DOMAIN(DocumentProcessing): ...; CONCEPT(PatternMatching): ...; TECH(Regexp): ...]
## @purpose BracketListPattern for document structure extraction pipeline
class BracketListPattern(RegexpPattern):
    ...
    def __init__(self, line_type: str, level_1: int, level_2: int, can_be_multiline: Optional[Union[bool, str]] = None) -> None:
        ...
        self.logger.debug(f"[IMP:4][BracketListPattern][__init___INIT] Starting")
    # endregion METHOD___init__
# endregion CLASS_BracketListPattern
# region MODULE_CONTRACT [DOMAIN(DocumentProcessing): ...; CONCEPT(PatternMatching): ...; TECH(Regexp): ...]
## @modulecontract
## @purpose Document structure extraction for structure_extractors/patterns/bracket_list_pattern: line classification, hierarchy level assignment, pattern matching.
## @scope Structure extraction pipeline — structure_extractors/patterns/bracket_list_pattern
...
## @modulemap
## CLASS [Weight 7][Structure extraction] => BracketListPattern
## @usecases
## - Extract structure: Reader → StructureExtractor → HierarchyBuilder → AnnotatedDocument
def _module_contract():
    pass
# endregion MODULE_CONTRACT
# GREP_SUMMARY: structure extractors, patterns, bracket list pattern
# STRUCTURE: ▶ structure_extractors/patterns/bracket_list_pattern → ○ BracketListPattern.cls → ⎋ result