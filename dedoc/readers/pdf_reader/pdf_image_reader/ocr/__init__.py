# region MODULE_CONTRACT [DOMAIN(8): DocumentProcessing; CONCEPT(7): Reader_ocr; TECH(6): Python, dedoc]
## @modulecontract
## @purpose Package init — marks ocr as a dedoc reader subpackage.
...
# GREP_SUMMARY: ocr, reader, dedoc, package, init, __init__
