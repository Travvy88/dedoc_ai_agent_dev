...
## @modulecontract
## @purpose Package init — marks columns_orientation_classifier as a dedoc reader subpackage.
...
# GREP_SUMMARY: columns_orientation_classifier, reader, dedoc, package, init, __init__
